...
class Mmca(Device):
    """Epics Mmca Motor Class updated from pyepics as an example for use with lcls pyepics3 
...
#            self.add_pv(pvrecord, attr=attr)
        ...
        if rectype != 'mmca':
            raise MotorException("%s is not an Epics MMC-100 Motor" % name)

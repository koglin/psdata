...
#  Epics Open License
#
#  J. Koglin Oct-2014 -- added mutable keyword -- needs to be False for ipython.
#   Obsolete with newer pyepics package (after ~3.2.3) 
"""
...
#    os.system('~xppopr/bin/motor-expert-screen '+self.pvname)

#    def archive(self,time_int=30,plotit=True):
#    """Extracts epics archive data of motor readback and dial_readback time_int 
#       days back (default is 30). time_int can also be passed a datestring 
#       (startdate from which to plot), or a list of timestrings (time interval to plot).
#    """

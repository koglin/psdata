...
class Mfx_focus_scan(psdata.Detector):
    """Sample Control for Detector Class of psdata.Detector.
...
#        return self.Dg3Pim.ami.entries
    ...
    def run_number(self):
        try:
            return self._data.daq.runnumber
        except:
            return 0
    ...
    def line_scan(self, nscans=1,
        ...
        if xwidth:
            ...
            if self.x.RTYP == 'ims' and self.x.VBAS > xspeed:
        ...
        if zwidth:
            ...
            if self.z.RTYP == 'ims' and self.z.VBAS > zspeed:
...
#        self.message.add(' - '+run_str) 
        ...
        if ywidth:
            ...
            if self.y.RTYP == 'ims' and self.y.VBAS > yspeed:

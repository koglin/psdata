...
def experiment_guess(*args, **kwargs):
    ...
    if is_in_group('ps-'+instrument) or is_in_psdata():
...
def instrument_guess(*args):
    ...
    if len(hostsplit) > 1 and hostsplit[1] in _lcls_instruments:
...
class pshome(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.user = get_username(**kwargs) 

        self._experiments = get_experiments(self.user)
